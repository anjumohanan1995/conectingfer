    ...
    <div class="main-content app-content">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between row me-0 ms-0">
                <div class="col-12">
                    <h4 class="content-title mb-2">Section 2(Innovations)</h4>
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        <div class="card">
                            <div class="card-body  table-new">
                                ...
                                <form class="m-5" action="{{ route('innovations.store') }}" method="POST"
                                    ...
                                    @php $array = json_decode($content->image, true); @endphp
                                        ...
                                        <div class="images-container">
                                            @foreach ($array as $image)
                                                <img src="{{ asset('innovations/' . @$image) }}" alt="Image"
