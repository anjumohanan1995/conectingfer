				...
				<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<form name="createForm" method="post" action="{{ route('service_list.update', $data->id) }}" enctype="multipart/form-data">                                    	@csrf
									@csrf
									@method('PUT')
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-md-9">   
												 ...
												 @if(@$data->image != '')
												 <img src="{{ asset('Services/' . $data->image) }}" width="200px" height="160px" />
												  @endif
												 @error('image')
													 <span class="text-danger">{{$message}}</span>
												 @enderror
