...
<div class="main-content app-content">
	...
	<div class="main-container container-fluid">
		...
		<div class="breadcrumb-header justify-content-between row me-0 ms-0 mb-3" >
			<div class="col-xl-3">
				<h4 class="content-title mb-2"> Edit Service </h4>
				...
				<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<form name="createForm" method="post" action="{{ route('home-services.update', $data->id) }}" enctype="multipart/form-data">                                    	@csrf
									@csrf
									@method('PUT')
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-md-9"><input type="text" class="form-control" placeholder="Icon" name="icon" value="{{@$data->icon}}" required/>
												@error('icon')
										...
										<div class="row">
											<div class="col-md-3"><label class="form-label">Order No</label></div>
											<div class="col-md-9"><input type="text" class="form-control" placeholder="Order No" name="order_no" value="{{ @$data->order_no }}" required/>
												@error('order_no')
													<span class="text-danger">{{$message}}</span>
												@enderror
											</div>
										...
										{{--  <div class="row">
											...
											<div class="col-md-9">   
												 ...
												 @if(@$data->image != '')
												 <img src="{{ asset('home_services/' . $data->image) }}" width="200px" height="160px" />
												  @endif
												 @error('image')
													 <span class="text-danger">{{$message}}</span>
												 @enderror
