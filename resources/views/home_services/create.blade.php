				...
				<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<form   method="post" action="{{route('home-services.store')}}" enctype="multipart/form-data">
                                    	@csrf
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-md-9"><input type="text" class="form-control" placeholder="Icon" name="icon" required/>
												@error('icon')
										...
										<div class="row">
											...
											<div class="col-md-9"><input type="text" class="form-control" placeholder="Order No" name="order_no" required />
												@error('order_no')
													<span class="text-danger">{{$message}}</span>
												@enderror
											</div>
