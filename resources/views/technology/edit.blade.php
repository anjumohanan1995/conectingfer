...
<div class="main-content app-content">
	...
	<div class="main-container container-fluid">
		...
		<div class="breadcrumb-header justify-content-between row me-0 ms-0 mb-3" >
			<div class="col-xl-3">
				<h4 class="content-title mb-2"> Edit Technology </h4>
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">

						<li class="breadcrumb-item active" aria-current="page"><i class="side-menu__icon fe fe-box"> </i> - Edit Technology</li>
					</ol>
				</nav>
			</div>
		</div>
				...
				<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
					<div class="card">
							...
							<div class="card-body">
								...
								<div class="mb-4 main-content-label">Technology - Information</div>
								<form name="createForm" method="post" action="{{ route('technology_list.update', $data->id) }}" enctype="multipart/form-data">                                    	@csrf
									@csrf
									@method('PUT')
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col-md-9">   
												 ...
												 @if(@$data->image != '')
												 <img src="{{ asset('Technology/' . $data->image) }}" width="200px" height="160px" />
												  @endif
												 @error('image')
													 <span class="text-danger">{{$message}}</span>
												 @enderror
